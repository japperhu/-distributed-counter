...
public class RedisSingletonClient implements JedisCommands,IRedisClient{
	/**
	 * redis单实例模式
	 */
	private JedisPool jedisPool;
	public RedisSingletonClient(JedisPool jedisPool) {
	...
	public void execute(IRedisClusterExecuteCallback redisClusterExecuteCallback) {
		throw new UnsupportedOperationException("singleton模式不支持cluster操作");
	}
